...
class Enlace(models.Model):
    ...
    grupo_de_enlace = models.ForeignKey(
        'GrupoDeEnlace', on_delete=models.SET_NULL, null=True)
...
class RedSocialEnlace(models.Model):
    ...
    red = models.ForeignKey('RedSocial', on_delete=models.SET_NULL,
                            null=True, help_text='Elige la red social que quieres editar')
    ...
    def __str__(self):
        """String que representa el servicio"""
        return f'{self.red} de {self.institucion}'
